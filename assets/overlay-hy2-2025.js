/**
 *  @class
 *  @function HYOverlay22025
 */

if (!customElements.get('image-with-text-overlay-hy2')) {
  class ImageTextOverlayHy2 extends HTMLElement {
    constructor() {
      super();
    ...
    prepareAnimations() {
      ...
      document.fonts.ready.then(function () {
        section.splittext = new SplitText(section.querySelectorAll('.image-with-text-overlay-hy2--heading, p:not(.subheading)'), {
          type: 'lines, words',
        ...
        if (section.querySelector('.image-with-text-overlay-hy2--heading')) {
          let h3_duration = 0.8 + ((section.querySelectorAll('.image-with-text-overlay-hy2--heading .line-child div').length - 1) * 0.08);
          section.tl
            .set(section.querySelector('.image-with-text-overlay-hy2--heading'), {
              visibility: 'visible'
            }, 0)
            .from(section.querySelectorAll('.image-with-text-overlay-hy2--heading .line-child div'), {
  ...
  customElements.define('image-with-text-overlay-hy2', ImageTextOverlayHy2);
}